...
subtitle: "Модель системы массового обслуживания M/M/1/oo"
...
Реализовать модель $M|M|1|\infty$ в *CPN tools*[@lab].

# Задание

- Реализовать в CPN Tools модель системы массового обслуживания $M|M|1|\infty$.
- Настроить мониторинг параметров моделируемой системы и нарисовать графики изменения задержки в очереди[@cpn].
...
(в форме ссылки на число 200) (рис. [-@fig:015]).
