...
Код состоит из трех блоков: первые два обрабатывают задания класса A и B, используя один элемент ЭВМ, а третий обрабатывает задания класса C, используя два элемента ЭВМ. Также есть блок времени генерирующий 4800 минут (80 часов).
...
Построим модель для первого варианта (рис. [-@fig:006]).
...
Построим модель для второго варианта (рис. [-@fig:010]).
